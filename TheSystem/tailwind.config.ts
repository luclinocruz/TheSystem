...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'neon-cyan': '0 0 15px rgba(34, 211, 238, 0.3), 0 0 30px rgba(34, 211, 238, 0.1)',
        'neon-cyan-lg': '0 0 25px rgba(34, 211, 238, 0.4), 0 0 50px rgba(34, 211, 238, 0.2)',
      ...
      keyframes: {
        ...
        "pulse-glow": {
          ...
          "50%": { opacity: "0.8", boxShadow: "0 0 25px rgba(34, 211, 238, 0.5)" },
        },
        "scan-line": {
